...
var vaultui = (function () {
    ...
    */
    ...
    var VaultFeedbacks = {
        vaultLoading: new VaultFeedback("?", "Checking SPRYPay Server Vault is running...", "vault-feedback1", "vault-loading"),
        ...
        noVault: new VaultFeedback("failed", "SPRYPay Server Vault does not seem to be running, you can download it on <a target=\"_blank\" href=\"https://github.com/sprypayserver/SPRYPayServer.Vault/releases/latest\">Github</a>.", "vault-feedback1", "no-vault"),
        ...
        bridgeConnected: new VaultFeedback("ok", "SPRYPayServer successfully connected to the vault.", "vault-feedback1", "bridge-connected"),
        vaultNeedUpdate: new VaultFeedback("failed", "Your SPRYPay Server Vault version is outdated. Please <a target=\"_blank\" href=\"https://github.com/sprypayserver/SPRYPayServer.Vault/releases/latest\">download</a> the latest version.", "vault-feedback2", "vault-outdated"),
