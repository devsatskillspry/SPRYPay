    ...
    app = new Vue({
        ...
        mounted: function () {
            ...
            eventAggregator.$on("invoice-created", function (invoiceId) {
                sprypay.appendAndShowInvoiceFrame(invoiceId);
 ...
 * with correctly displayed fraction amount (e.g. 0.012345 for SPRY instead of just 0.0123)
 * 
 * @param {number | string} amount Amount to format
 * @param {number} divisibility Currency divisibility (e.g., 8 for SPRY)
