...
namespace SPRYPayServer.Services
{
    public static class EmailSenderExtensions
    {
        ...
        private static string HEADER_HTML = "<h1 style='font-size:1.2rem'>SPRYPay Server</h1><br/>";
        ...
        public static void SendSetPasswordConfirmation(this IEmailSender emailSender, MailboxAddress address, string link, bool newPassword)
        {
            ...
            var body = $"A request has been made to {(newPassword ? "set" : "update")} your SPRYPay Server password. Please confirm your password by clicking below. <br/><br/> {CallToAction(subject, HtmlEncoder.Default.Encode(link))}";
