...
using SPRYPayServer.Models.AccountViewModels;
...
namespace SPRYPayServer.Controllers
{
    ...
    public class UIAccountController : Controller
    {
        ...
        readonly Configuration.SPRYPayServerOptions _Options;
        private readonly SPRYPayServerEnvironment _btcPayServerEnvironment;
        ...
        public UIAccountController(
            ...
            Configuration.SPRYPayServerOptions options,
            SPRYPayServerEnvironment btcPayServerEnvironment,
        ...
        private IActionResult RedirectToLocal(string returnUrl = null)
        {
            ...
            // After login, if there is an app on "/", we should redirect to SPRYPay explicit home route, and not to the app.
