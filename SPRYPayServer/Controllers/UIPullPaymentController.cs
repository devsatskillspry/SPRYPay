...
namespace SPRYPayServer.Controllers
{
    public class UIPullPaymentController : Controller
    {
        ...
        private readonly SPRYPayNetworkJsonSerializerSettings _serializerSettings;
        ...
        public UIPullPaymentController(ApplicationDbContextFactory dbContextFactory,
            ...
            SPRYPayNetworkJsonSerializerSettings serializerSettings,
        ...
        public async Task<IActionResult> ClaimPullPayment(string pullPaymentId, ViewPullPaymentModel vm, CancellationToken cancellationToken)
        {
            ...
            {
                var amount = ppBlob.Currency == "SATS" ? new Money(vm.ClaimedAmount, MoneyUnit.Satoshi).ToUnit(MoneyUnit.SPRY) : vm.ClaimedAmount;
