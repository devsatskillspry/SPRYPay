...
using SPRYPayServer.Components.StoreLightningBalance;
using SPRYPayServer.Components.StoreNumbers;
using SPRYPayServer.Components.StoreRecentInvoices;
    ...
    public partial class UIStoresController
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var vm = new StoreDashboardViewModel
            {
                ...
                LightningSupported = _NetworkProvider.GetNetwork<SPRYPayNetwork>(cryptoCode)?.SupportLightning is true,
