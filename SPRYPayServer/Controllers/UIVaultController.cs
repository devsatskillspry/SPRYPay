...
namespace SPRYPayServer.Controllers
{
    ...
    public class UIVaultController : Controller
    {
        ...
        public UIVaultController(SPRYPayNetworkProvider networks, IAuthorizationService authorizationService)
        {
            Networks = networks;
            _authorizationService = authorizationService;
        }

        public SPRYPayNetworkProvider Networks { get; }
            ...
            WalletId walletId = null)
        {
            ...
            using (var cts = new CancellationTokenSource(TimeSpan.FromMinutes(10)))
            {
                ...
                var network = Networks.GetNetwork<SPRYPayNetwork>(cryptoCode);
                if (network == null)
                    return NotFound();
...
askdevice:
        ...
        private DerivationSchemeSettings GetDerivationSchemeSettings(WalletId walletId)
        {
            var paymentMethod = CurrentStore
                            ...
                            .FirstOrDefault(p => p.PaymentId.PaymentType == Payments.PaymentTypes.SPRYLike && p.PaymentId.CryptoCode == walletId.CryptoCode);
