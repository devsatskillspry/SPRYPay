...
using SPRYPayServer.Storage.Services.Providers.AmazonS3Storage;
using SPRYPayServer.Storage.Services.Providers.AmazonS3Storage.Configuration;
using SPRYPayServer.Storage.Services.Providers.AzureBlobStorage;
using SPRYPayServer.Storage.Services.Providers.AzureBlobStorage.Configuration;
using SPRYPayServer.Storage.Services.Providers.FileSystemStorage;
using SPRYPayServer.Storage.Services.Providers.FileSystemStorage.Configuration;
using SPRYPayServer.Storage.Services.Providers.GoogleCloudStorage;
...
using SPRYPayServer.Storage.ViewModels;
...
namespace SPRYPayServer.Controllers
{
    public partial class UIServerController
    {
        ...
        public async Task<IActionResult> Storage(bool forceChoice = false)
        {
            ...
            if (forceChoice || savedSettings == null)
            {
                ...
                return View(new ChooseStorageViewModel
                {
                    ...
                    Provider = savedSettings?.Provider ?? SPRYPayServer.Storage.Models.StorageProvider.FileSystem
                });
            }
        ...
        public async Task<IActionResult> StorageProvider(string provider)
        {
            ...
            switch (storageProviderService)
            {
                ...
                case FileSystemFileProviderService fileProviderService:
                    if (data.Provider != SPRYPayServer.Storage.Models.StorageProvider.FileSystem)
                    {
                        _ = await SaveStorageProvider(new FileSystemStorageConfiguration(),
                            SPRYPayServer.Storage.Models.StorageProvider.FileSystem);
                    }
        ...
        {
            return await SaveStorageProvider(viewModel, SPRYPayServer.Storage.Models.StorageProvider.AzureBlobStorage);
        }
        ...
        {
            return await SaveStorageProvider(viewModel, SPRYPayServer.Storage.Models.StorageProvider.AmazonS3);
        }
        ...
        {
            return await SaveStorageProvider(viewModel, SPRYPayServer.Storage.Models.StorageProvider.GoogleCloudStorage);
        }
        ...
        {
            return await SaveStorageProvider(viewModel, SPRYPayServer.Storage.Models.StorageProvider.FileSystem);
        }
