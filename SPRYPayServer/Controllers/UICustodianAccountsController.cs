...
using SPRYPayServer.Models.CustodianAccountViewModels;
...
using CustodianAccountData = SPRYPayServer.Data.CustodianAccountData;
...
namespace SPRYPayServer.Controllers
{
    ...
    public class UICustodianAccountsController : Controller
    {
        ...
        private readonly SPRYPayServerClient _btcPayServerClient;
        ...
        public UICustodianAccountsController(
            ...
            SPRYPayServerClient btcPayServerClient,
            ...
            EditCustodianAccountViewModel vm)
        {
            ...
            foreach (var pair in Request.Form)
            {
                ...
                {
                    // TODO support posted array notation, like a field called "WithdrawToAddressNamePerPaymentMethod[SPRY-OnChain]". The data should be nested in the JSON.
            ...
            [FromQuery] string assetToTrade, [FromQuery] string assetToTradeInto)
        {
            ...
            var store = GetCurrentStore();
            var storeBlob = SPRYPayServer.Data.StoreDataExtensions.GetStoreBlob(store);
            var defaultCurrency = storeBlob.DefaultCurrency;
            ...
            try
            {
                if (custodian is ICanDeposit depositableCustodian)
                {
                    ...
                    try
                    {
                        ...
                        if (paymentMethodObj.IsSPRYOnChain)
                        {
                            var network = _networkProvider.GetNetwork<SPRYPayNetwork>("SPRY");
        ...
        {
            // TODO this method was copy-pasted from SPRYPayServer.Controllers.UIWalletsController.GetImage(). Maybe refactor this?
