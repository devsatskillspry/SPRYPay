...
using static SPRYPayServer.Plugins.PluginService;
...
namespace SPRYPayServer.Controllers
{
    public partial class UIServerController
    {
        ...
        public async Task<IActionResult> ListPlugins(
            ...
            [FromServices] SPRYPayServerOptions btcPayServerOptions)
        {
        ...
        {
            public IEnumerable<ISPRYPayServerPlugin> Installed { get; set; }
            ...
            List<IFormFile> files)
        {
            foreach (var formFile in files.Where(file => file.Length > 0).Where(file => file.FileName.IsValidFileName()))
            {
                ...
                pluginService.InstallPlugin(formFile.FileName.TrimEnd(PluginManager.SPRYPayPluginSuffix,
