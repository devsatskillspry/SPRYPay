    ...
    public partial class GreenfieldStoreOnChainPaymentMethodsController : ControllerBase
    {
            ...
            SPRYPayNetworkProvider networkProvider, bool? enabled)
        {
            ...
            return store.GetSupportedPaymentMethods(networkProvider)
                .Where((method) => method.PaymentId.PaymentType == PaymentTypes.SPRYLike)
        ...
        public ActionResult<OnChainPaymentMethodData> GetOnChainPaymentMethod(
            ...
            string cryptoCode)
        {
            AssertCryptoCodeWallet(cryptoCode, out SPRYPayNetwork _, out SPRYPayWallet _);
        ...
        private void AssertCryptoCodeWallet(string cryptoCode, out SPRYPayNetwork network, out SPRYPayWallet wallet)
        {
