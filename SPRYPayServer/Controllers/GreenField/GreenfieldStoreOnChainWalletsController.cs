...
namespace SPRYPayServer.Controllers.Greenfield
{
    ...
    public class GreenfieldStoreOnChainWalletsController : Controller
    {
        ...
        private readonly SPRYPayWalletProvider _btcPayWalletProvider;
        ...
        public GreenfieldStoreOnChainWalletsController(
            ...
            SPRYPayWalletProvider btcPayWalletProvider,
...
#pragma warning restore CS0612 // Type or member is obsolete
            ...
            [FromBody] CreateOnChainTransactionRequest request)
        {
            ...
            var changed = psbt.PSBT.PSSPRYhanged(() => psbt.PSBT.SignAll(derivationScheme.AccountDerivation, accountKey,
                rootedKeyPath));
        ...
        private bool IsInvalidWalletRequest(string cryptoCode, [MaybeNullWhen(true)] out SPRYPayNetwork network,
            ...
            [MaybeNullWhen(false)] out IActionResult actionResult)
        {
            ...
            if (network is null)
            {
                throw new JsonHttpException(this.CreateAPIError(404, "unknown-cryptocode",
                    "This crypto code isn't set up in this SPRYPay Server instance"));
            }
        ...
        private DerivationSchemeSettings? GetDerivationSchemeSettings(string cryptoCode)
        {
            var paymentMethod = Store
                ...
                .FirstOrDefault(p =>
                    p.PaymentId.PaymentType == Payments.PaymentTypes.SPRYLike &&
