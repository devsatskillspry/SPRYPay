...
using InvoiceData = SPRYPayServer.Client.Models.InvoiceData;
using Language = SPRYPayServer.Client.Models.Language;
using LightningAddressData = SPRYPayServer.Client.Models.LightningAddressData;
using NotificationData = SPRYPayServer.Client.Models.NotificationData;
using PaymentRequestData = SPRYPayServer.Client.Models.PaymentRequestData;
using PayoutData = SPRYPayServer.Client.Models.PayoutData;
using PullPaymentData = SPRYPayServer.Client.Models.PullPaymentData;
using StoreData = SPRYPayServer.Client.Models.StoreData;
using StoreWebhookData = SPRYPayServer.Client.Models.StoreWebhookData;
using WebhookDeliveryData = SPRYPayServer.Client.Models.WebhookDeliveryData;

namespace SPRYPayServer.Controllers.Greenfield
{
    public class SPRYPayServerClientFactory : ISPRYPayServerClientFactory
    {
        ...
        public SPRYPayServerClientFactory(
        ...
        public Task<SPRYPayServerClient> Create(string userId, params string[] storeIds)
        {
        ...
        public async Task<SPRYPayServerClient> Create(string userId, string[] storeIds, HttpContext context)
        {
            ...
            return ActivatorUtilities.CreateInstance<LocalSPRYPayServerClient>(_serviceProvider,
    ...
    public class LocalSPRYPayServerClient : SPRYPayServerClient
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IServiceProvider _serviceProvider;


        public LocalSPRYPayServerClient(
        ...
        {
            throw new NotSupportedException("This method is not supported by the LocalSPRYPayServerClient.");
        }
