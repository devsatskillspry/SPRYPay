...
namespace SPRYPayServer.Controllers.Greenfield
{
    ...
    public abstract class GreenfieldLightningNodeApiController : Controller
    {
        ...
        protected GreenfieldLightningNodeApiController(SPRYPayNetworkProvider btcPayNetworkProvider,
        ...
        {
            return new JsonHttpException(this.CreateAPIError(404, "unknown-cryptocode", "This crypto code isn't set up in this SPRYPay Server instance"));
        }
        protected JsonHttpException ErrorShouldBeAdminForInternalNode()
        {
            return new JsonHttpException(this.CreateAPIPermissionError("sprypay.server.canuseinternallightningnode", "The user should be admin to use the internal lightning node"));
        }
