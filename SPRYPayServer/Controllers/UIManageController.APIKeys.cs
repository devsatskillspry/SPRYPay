        ...
        public class AddApiKeyViewModel
        {
            ...
            public class PermissionValueItem
            {
                public static readonly Dictionary<string, (string Title, string Description)> PermissionDescriptions = new Dictionary<string, (string Title, string Description)>()
                {
                    ...
                    {Policies.CanUseInternalLightningNode, ("Use the internal lightning node", "The app will be able to  use the internal SPRYPay Server lightning node to create BOLT11 invoices, connect to other nodes, open new channels and pay BOLT11 invoices.")},
                    {Policies.CanViewLightningInvoiceInternalNode, ("View invoices from internal lightning node", "The app will be able to use the internal SPRYPay Server lightning node to view BOLT11 invoices.")},
                    {Policies.CanCreateLightningInvoiceInternalNode, ("Create invoices with internal lightning node", "The app will be able to use the internal SPRYPay Server lightning node to create BOLT11 invoices.")},
