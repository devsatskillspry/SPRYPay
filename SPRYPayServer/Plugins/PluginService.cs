...
using SPRYPayServer.Lightning.CLightning;
...
namespace SPRYPayServer.Plugins
{
    public class PluginService
    {
        ...
        public PluginService(
            ...
            IEnumerable<ISPRYPayServerPlugin> btcPayServerPlugins,
        ...
        public IEnumerable<ISPRYPayServerPlugin> LoadedPlugins { get; }
        public SPRYPayServerEnvironment Env { get; }
        ...
        public async Task DownloadRemotePlugin(string pluginIdentifier, string version)
        {
            ...
            var filedest = Path.Join(dest, pluginIdentifier + ".sprypay");
        ...
        public async Task UploadPlugin(IFormFile plugin)
        {
            ...
            Directory.CreateDirectory(Path.GetDirectoryName(filedest));
            if (Path.GetExtension(filedest) == PluginManager.SPRYPayPluginSuffix)
            {
        ...
        public class AvailablePlugin
        {
            ...
            public ISPRYPayServerPlugin.PluginDependency[] Dependencies { get; set; } = Array.Empty<ISPRYPayServerPlugin.PluginDependency>();
