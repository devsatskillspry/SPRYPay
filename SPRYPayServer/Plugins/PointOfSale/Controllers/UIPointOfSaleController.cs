...
using SPRYPayServer.Forms.Models;
...
namespace SPRYPayServer.Plugins.PointOfSale.Controllers
{
    ...
    public class UIPointOfSaleController : Controller
    {
        ...
        public async Task<IActionResult> UpdatePointOfSale(string appId)
        {
            ...
            vm.ExampleCallback = "{\n  \"id\":\"SkdsDghkdP3D3qkj7bLq3\",\n  \"url\":\"https://sprypay.example.com/invoice?id=SkdsDghkdP3D3qkj7bLq3\",\n  \"status\":\"paid\",\n  \"price\":10,\n  \"currency\":\"EUR\",\n  \"invoiceTime\":1520373130312,\n  \"expirationTime\":1520374030312,\n  \"currentTime\":1520373179327,\n  \"exceptionStatus\":false,\n  \"buyerFields\":{\n    \"buyerEmail\":\"customer@example.com\",\n    \"buyerNotify\":false\n  },\n  \"paymentSubtotals\": {\n    \"SPRY\":114700\n  },\n  \"paymentTotals\": {\n    \"SPRY\":118400\n  },\n  \"transactionCurrency\": \"SPRY\",\n  \"amountPaid\": \"1025900\",\n  \"exchangeRates\": {\n    \"SPRY\": {\n      \"EUR\": 8721.690715789999,\n      \"USD\": 10817.99\n    }\n  }\n}";
