...
#nullable restore
    ...
    public class PluginBuilderClient
    {
        ...
        public async Task<PublishedVersion[]> GetPublishedVersions(string sprypayVersion, bool includePreRelease)
        {
            var result = await httpClient.GetStringAsync($"api/v1/plugins?sprypayVersion={sprypayVersion}&includePreRelease={includePreRelease}");
