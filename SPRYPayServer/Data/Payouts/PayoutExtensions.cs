...
namespace SPRYPayServer.Data
{
    public static class PayoutExtensions
    {
        ...
        public static PayoutBlob GetBlob(this PayoutData data, SPRYPayNetworkJsonSerializerSettings serializers)
        {
        ...
        public static void SetBlob(this PayoutData data, PayoutBlob blob, SPRYPayNetworkJsonSerializerSettings serializers)
        {
