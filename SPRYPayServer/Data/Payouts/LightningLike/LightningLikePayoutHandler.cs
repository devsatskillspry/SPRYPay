...
namespace SPRYPayServer.Data.Payouts.LightningLike
{
    public class LightningLikePayoutHandler : IPayoutHandler
    {
        ...
        public LightningLikePayoutHandler(SPRYPayNetworkProvider btcPayNetworkProvider,
        ...
        public bool CanHandle(PaymentMethodId paymentMethod)
        {
            return (paymentMethod.PaymentType == LightningPaymentType.Instance || paymentMethod.PaymentType == LNURLPayPaymentType.Instance) &&
                   _btcPayNetworkProvider.GetNetwork<SPRYPayNetwork>(paymentMethod.CryptoCode)?.SupportLightning is true;
        }
        ...
        {
            return Task.FromResult(Money.Satoshis(1).ToDecimal(MoneyUnit.SPRY));
        }
