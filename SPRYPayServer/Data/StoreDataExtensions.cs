...
#pragma warning disable CS0618
        ...
        public static PaymentMethodId[] GetEnabledPaymentIds(this StoreData storeData, SPRYPayNetworkProvider networks)
        {
            return GetEnabledPaymentMethods(storeData, networks).Select(method => method.PaymentId).ToArray();
        }

        public static ISupportedPaymentMethod[] GetEnabledPaymentMethods(this StoreData storeData, SPRYPayNetworkProvider networks)
        {
            ...
            var paymentMethodIds = storeData.GetSupportedPaymentMethods(networks)
                ...
                .OrderByDescending(a => a.PaymentId.CryptoCode == "SPRY")
...
#pragma warning restore CS0618
        ...
        public static IEnumerable<ISupportedPaymentMethod> GetSupportedPaymentMethods(this StoreData storeData, SPRYPayNetworkProvider networks)
        {
...
#pragma warning disable CS0618
            ...
            if (!string.IsNullOrEmpty(storeData.DerivationStrategies))
            {
                ...
                foreach (var strat in strategies.Properties())
                {
                    ...
                    if (network != null)
                    {
                        if (network == networks.SPRY && paymentMethodId.PaymentType == PaymentTypes.SPRYLike && btcReturned)
                            continue;
...
#pragma warning restore CS0618
        ...
        public static bool IsLightningEnabled(this StoreData storeData, SPRYPayNetworkProvider networks, string cryptoCode)
        {
            return IsPaymentTypeEnabled(storeData, networks, cryptoCode, LightningPaymentType.Instance);
        }

        public static bool IsLNUrlEnabled(this StoreData storeData, SPRYPayNetworkProvider networks, string cryptoCode)
        {
            return IsPaymentTypeEnabled(storeData, networks, cryptoCode, LNURLPayPaymentType.Instance);
        }
        
        private static bool IsPaymentTypeEnabled(this StoreData storeData, SPRYPayNetworkProvider networks, string cryptoCode, PaymentType paymentType)
        {
