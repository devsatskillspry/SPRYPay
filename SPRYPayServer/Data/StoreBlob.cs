...
using System.Linq;
using System.Text;
using SPRYPayServer.Client.JsonConverters;
...
#nullable restore
        ...
        public SPRYPayServer.Rating.RateRules GetRateRules(SPRYPayNetworkProvider networkProvider)
        {
            return GetRateRules(networkProvider, out _);
        }
        public SPRYPayServer.Rating.RateRules GetRateRules(SPRYPayNetworkProvider networkProvider, out bool preferredSource)
        {
            if (!RateScripting ||
                string.IsNullOrEmpty(RateScript) ||
                !SPRYPayServer.Rating.RateRules.TryParse(RateScript, out var rules))
            {
        ...
        public RateRules GetDefaultRateRules(SPRYPayNetworkProvider networkProvider)
        {
            ...
            SPRYPayServer.Rating.RateRules.TryParse(builder.ToString(), out var rules);
            rules.Spread = Spread;
            return rules;
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        // Replace absolute URL with relative to avoid this issue: https://github.com/sprypayserver/sprypayserver/discussions/4195
