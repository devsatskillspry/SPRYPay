...
{
    public class SPRYPayMiddleware
    {
        readonly RequestDelegate _Next;
        readonly SPRYPayServerOptions _Options;

        public Logs Logs { get; }

        readonly SPRYPayServerEnvironment _Env;

        public SPRYPayMiddleware(RequestDelegate next,
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            {
                Logs.PayServer.LogCritical(new EventId(), ex, "Unhandled exception in SPRYPayMiddleware");
                throw;
            }
            await _Next(httpContext);
        }
