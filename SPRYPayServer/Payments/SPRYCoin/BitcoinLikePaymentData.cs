...
namespace SPRYPayServer.Payments.Bitcoin
{
    ...
    public class BitcoinLikePaymentData : CryptoPaymentData
    {
        ...
        /// <summary>
        /// This is set to true if the payment was created before CryptoPaymentData existed in SPRYPayServer
        /// </summary>
        ...
        {
            return Value?.GetValue(Network as SPRYPayNetwork) ?? Output.Value.ToDecimal(MoneyUnit.SPRY);
        }

        public bool PaymentCompleted(PaymentEntity entity)
        {
            return ConfirmationCount >= ((SPRYPayNetwork)Network).MaxTrackedConfirmation;
        }
        ...
        {
            return Address ?? Output.ScriptPubKey.GetDestinationAddress(((SPRYPayNetwork)Network).NBitcoinNetwork);
        }
