...
namespace SPRYPayServer.Payments.Bitcoin
{
    public class BitcoinLikePaymentHandler : PaymentMethodHandlerBase<DerivationSchemeSettings, SPRYPayNetwork>
    {
        ...
        private readonly Services.Wallets.SPRYPayWalletProvider _WalletProvider;
        ...
        public BitcoinLikePaymentHandler(ExplorerClientProvider provider,
            ...
            Services.Wallets.SPRYPayWalletProvider walletProvider)
        {
            ...
            _bech32Prefix = networkProvider.GetAll().OfType<SPRYPayNetwork>()
            ...
            StoreBlob storeBlob, IPaymentMethod paymentMethod)
        {
            ...
            var network = _networkProvider.GetNetwork<SPRYPayNetwork>(model.CryptoCode);
            ...
            if (model.Activated)
            {
                ...
                if (network.CryptoCode.Equals("SPRY", StringComparison.InvariantCultureIgnoreCase) && _bech32Prefix.TryGetValue(model.CryptoCode, out var prefix) && model.BtcAddress.StartsWith(prefix, StringComparison.OrdinalIgnoreCase))
                {
        ...
        private string GetCryptoImage(SPRYPayNetworkBase network)
        {
        ...
        public override IEnumerable<PaymentMethodId> GetSupportedPaymentMethods()
        {
            return _networkProvider
                .GetAll()
                .OfType<SPRYPayNetwork>()
                .Select(network => new PaymentMethodId(network.CryptoCode, PaymentTypes.SPRYLike));
        }

        private string GetPaymentMethodName(SPRYPayNetworkBase network)
        {
        ...
        public override PaymentType PaymentType => PaymentTypes.SPRYLike;

        public override async Task<IPaymentMethodDetails> CreatePaymentMethodDetails(
            InvoiceLogs logs,
            DerivationSchemeSettings supportedPaymentMethod, PaymentMethod paymentMethod, StoreData store,
            SPRYPayNetwork network, object preparePaymentObject, IEnumerable<PaymentMethodId> invoicePaymentMethods)
        {
