...
using System.Linq;
#if ALTCOINS
using SPRYPayServer.Services.Altcoins.Monero.Payments;
using SPRYPayServer.Services.Altcoins.Zcash.Payments;
#endif
...
namespace SPRYPayServer.Payments
{
    ...
    public static class PaymentTypes
    {
        ...
        {
            SPRYLike, LightningLike, LNURLPay,
#if ALTCOINS
        ...
        /// </summary>
        public static BitcoinPaymentType SPRYLike => BitcoinPaymentType.Instance;
        /// <summary>
        /// Lightning payment
        /// </summary>
    ...
    public abstract class PaymentType
    {
        ...
        public abstract CryptoPaymentData DeserializePaymentData(SPRYPayNetworkBase network, string str);
        public abstract string SerializePaymentData(SPRYPayNetworkBase network, CryptoPaymentData paymentData);
        public abstract IPaymentMethodDetails DeserializePaymentMethodDetails(SPRYPayNetworkBase network, string str);
        public abstract string SerializePaymentMethodDetails(SPRYPayNetworkBase network, IPaymentMethodDetails details);
        public abstract ISupportedPaymentMethod DeserializeSupportedPaymentMethod(SPRYPayNetworkBase network, JToken value);
        public abstract string GetTransactionLink(SPRYPayNetworkBase network, string txId);
        public abstract string GetPaymentLink(SPRYPayNetworkBase network, IPaymentMethodDetails paymentMethodDetails,
