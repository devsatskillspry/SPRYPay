...
namespace SPRYPayServer.Payments
{
    ...
    public class PaymentMethodId
    {
        ...
        public bool IsSPRYOnChain
        {
            get
            {
                return CryptoCode == "SPRY" && PaymentType == PaymentTypes.SPRYLike;
            }
        }
...
#pragma warning restore CA1307 // Specify StringComparison
        ...
        {
            //SPRYLike case is special because it is in legacy mode.
            return PaymentType == PaymentTypes.SPRYLike ? CryptoCode : $"{CryptoCode}_{PaymentType}";
        }
        /// <summary>
        ...
        {
            if (PaymentType == PaymentTypes.SPRYLike)
                return CryptoCode;
#if ALTCOINS
        ...
        public static bool TryParse(string? str, [MaybeNullWhen(false)] out PaymentMethodId paymentMethodId)
        {
            ...
            if (parts.Length == 0 || parts.Length > 2)
                return false;
            PaymentType type = PaymentTypes.SPRYLike;
#if ALTCOINS
