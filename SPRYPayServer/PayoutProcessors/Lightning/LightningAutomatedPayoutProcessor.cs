...
public class LightningAutomatedPayoutProcessor : BaseAutomatedPayoutProcessor<AutomatedPayoutBlob>
{
    ...
    private readonly SPRYPayNetwork _network;
    ...
    public LightningAutomatedPayoutProcessor(
        ...
        ApplicationDbContextFactory applicationDbContextFactory, PullPaymentHostedService pullPaymentHostedService, SPRYPayNetworkProvider btcPayNetworkProvider) :
            ...
            btcPayNetworkProvider)
    {
        ...
        _network = _btcPayNetworkProvider.GetNetwork<SPRYPayNetwork>(_PayoutProcesserSettings.GetPaymentMethodId().CryptoCode);
    }
