...
namespace SPRYPayServer.Services
{
    public class TorServices : BaseAsyncService
    {
        ...
        private readonly IOptions<SPRYPayServerOptions> _options;


        public TorServices(SPRYPayNetworkProvider btcPayNetworkProvider, IOptions<SPRYPayServerOptions> options, Logs logs) : base(logs)
        {
        ...
        private bool TryParseCryptoSpecificService(string name, out SPRYPayNetworkBase network,
