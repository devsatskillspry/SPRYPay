...
namespace SPRYPayServer.Services.Invoices
{
    public class PaymentService
    {
        ...
        public PaymentService(EventAggregator eventAggregator,
            ...
            SPRYPayNetworkProvider btcPayNetworkProvider, InvoiceRepository invoiceRepository)
        {
        ...
        public async Task<PaymentEntity> AddPayment(string invoiceId, DateTimeOffset date, CryptoPaymentData paymentData, SPRYPayNetworkBase network, bool accounted = false)
        {
