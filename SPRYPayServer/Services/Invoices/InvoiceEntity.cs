...
using SPRYPayServer.JsonConverters;
...
namespace SPRYPayServer.Services.Invoices
{
    ...
    public class InvoiceEntity
    {
        ...
        [JsonIgnore]
        public SPRYPayNetworkProvider Networks { get; set; }
...
#pragma warning disable CS0618
            ...
            if (!string.IsNullOrEmpty(DerivationStrategies))
            {
                ...
                foreach (var strat in strategies.Properties())
                {
                    ...
                    var network = Networks.GetNetwork<SPRYPayNetworkBase>(paymentMethodId.CryptoCode);
                    if (network != null)
                    {
                        if (network == Networks.SPRY && paymentMethodId.PaymentType == PaymentTypes.SPRYLike)
                            btcReturned = true;
            ...
            {
                if (Networks.SPRY != null)
                {
                    yield return SPRYPayServer.DerivationSchemeSettings.Parse(DerivationStrategy, Networks.SPRY);
                }
            }
...
#pragma warning disable CS0618
        ...
        public List<PaymentEntity> GetPayments(SPRYPayNetworkBase network, bool accountedOnly)
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            foreach (var info in this.GetPaymentMethods())
            {
                ...
                if (details?.Activated is true)
                {
                    ...
                    if (paymentId.PaymentType == PaymentTypes.SPRYLike)
                    {
...
#pragma warning disable 618
                        if (info.CryptoCode == "SPRY")
                        {
                            dto.SPRYPrice = cryptoInfo.Price;
                            dto.Rate = cryptoInfo.Rate;
                            dto.ExRates = cryptoInfo.ExRates;
                            dto.BitcoinAddress = cryptoInfo.Address;
                            dto.SPRYPaid = cryptoInfo.Paid;
                            dto.SPRYDue = cryptoInfo.Due;
...
#pragma warning restore 618
            ...
            //dto.AmountPaid dto.MinerFees & dto.TransactionCurrency are not supported by sprypayserver as we have multi currency payment support per invoice
        ...
        public PaymentMethod GetPaymentMethod(SPRYPayNetworkBase network, PaymentType paymentType)
        {
...
#pragma warning disable CS0618
            if (PaymentMethod != null)
            {
                foreach (var prop in PaymentMethod.Properties())
                {
                    ...
                    if (Networks != null)
                    {
                        r.Network = Networks.GetNetwork<SPRYPayNetworkBase>(r.CryptoCode);
...
#pragma warning restore CS0618
    ...
    public class PaymentMethod : IPaymentMethod
    {
        ...
        {
#pragma warning disable CS0618 // Type or member is obsolete
            return new PaymentMethodId(CryptoCode, string.IsNullOrEmpty(PaymentType) ? PaymentTypes.SPRYLike : PaymentTypes.Parse(PaymentType));
#pragma warning restore CS0618 // Type or member is obsolete
        }
...
#pragma warning disable CS0618 // Type or member is obsolete
            ...
            return new PaymentMethodId(CryptoCode ?? "SPRY", paymentType);
#pragma warning restore CS0618 // Type or member is obsolete
        }
...
#pragma warning restore CS0618
    ...
    {
        [JsonIgnore]
        SPRYPayNetworkBase Network { get; set; }
        /// <summary>
