...
{
    [Display(Name = "Does not extend a SPRYPay Server theme, fully custom")]
    Custom,
    [Display(Name = "Extends the SPRYPay Server Light theme")]
    Light,
    [Display(Name = "Extends the SPRYPay Server Dark theme")]
    Dark
}
