...
namespace SPRYPayServer.Services
{
    public class PoliciesSettings
    {
        ...
        [Display(Name = "Check releases on GitHub and notify when new SPRYPay Server version is available")]
        ...
        public const string DefaultPluginSource = "https://plugin-builder.sprypayserver.org";
        [UriAttribute]
