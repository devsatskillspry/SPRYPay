...
namespace SPRYPayServer.Services
{
    ...
    public class DynamicDnsService
    {
        ...
        public HttpRequestMessage CreateUpdateRequest()
        {
            ...
            webRequest.Headers.TryAddWithoutValidation("User-Agent", $"SPRYPayServer/{GetVersion()} sprypayserver@gmail.com");
        ...
        {
            return typeof(SPRYPayServerEnvironment).GetTypeInfo().Assembly.GetCustomAttribute<AssemblyFileVersionAttribute>().Version;
        }
    }
}
