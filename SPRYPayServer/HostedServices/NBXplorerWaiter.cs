...
namespace SPRYPayServer.HostedServices
{
    ...
    public class NBXplorerDashboard
    {
        ...
        public void Publish(SPRYPayNetworkBase network, NBXplorerState state, StatusResult status, string error)
        {
    ...
    public class NBXplorerWaiter : IHostedService
    {
        ...
        public NBXplorerWaiter(NBXplorerDashboard dashboard, SPRYPayNetwork network, ExplorerClient client, EventAggregator aggregator, Logs logs)
        {
            this.Logs = logs;
            _Network = network;
            _Client = client;
        ...
        readonly SPRYPayNetwork _Network;
