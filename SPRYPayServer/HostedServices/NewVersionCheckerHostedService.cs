...
namespace SPRYPayServer.HostedServices
{
    public class NewVersionCheckerHostedService : BaseAsyncService
    {
        ...
        public NewVersionCheckerHostedService(SettingsRepository settingsRepository, SPRYPayServerEnvironment env,
    ...
    public class GithubVersionFetcher : IVersionFetcher
    {
        ...
        public GithubVersionFetcher(IHttpClientFactory httpClientFactory, SPRYPayServerOptions options, Logs logs)
        {
            Logs = logs;
            _httpClient = httpClientFactory.CreateClient(nameof(GithubVersionFetcher));
            _httpClient.DefaultRequestHeaders.Add("Accept", "application/vnd.github.v3+json");
            _httpClient.DefaultRequestHeaders.Add("User-Agent", "SPRYPayServer/NewVersionChecker");
